...
def update_website_context(context):
	...
	# Frappe falls back to its own favicon when Website Settings has no custom
	# icon. Keep every server-rendered website page branded consistently.
	context.favicon = BHASHA_FAVICON
