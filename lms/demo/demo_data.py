	...
	course.update(
		{
			...
			"short_introduction": "Learn the basics of Bhasha and how to get started with your very first course.",
			"image": "/assets/lms/images/course_card.jpeg",
		}
	)

	course.description = """
		This course will cover the fundamentals of Bhasha, including how to create and manage courses, enroll students, and track progress. You will learn about the following key features of the app:
		<br>
		<h3>Key Features</h3>
		<br>
		...
		<br>
		<br>
		To know more about the app and its features, <a href="https://bhasha.io">visit Bhasha</a>.
 """
	course.save()
	return course
...
def create_quiz():
	...
	questions.append(
		create_quiz_questions(
			"What is Bhasha primarily used for?",
			"Project Management",
			False,
			"Learning Management",
			True,
	...
	questions.append(
		create_quiz_questions(
			"Which of the following can be added to a course in Bhasha?",
			"Lessons",
			True,
			"Issues",
			False,
	...
	questions.append(
		create_quiz_questions(
			"What is the top-level structure in Bhasha?", "Chapter", False, "Course", True
		)
	)
	questions.append(
		create_quiz_questions("Can you create quizzes in Bhasha?", "Yes", True, "No", False)
	)
	questions.append(
		create_quiz_questions(
	...
	questions.append(
		create_quiz_questions("Can you track learner progress in Bhasha?", "Yes", True, "No", False)
	)
	questions.append(
		create_quiz_questions(
			"What is the purpose of a batch in Bhasha?",
			"To group learners",
			True,
	...
	questions.append(
		create_quiz_questions(
			"How can you create custom certificates in Bhasha?",
...
def create_reviews(course, student):
	...
	review.rating = 0.8
	review.review = "This is a great course to get started with Bhasha. The content is well-structured and easy to follow."
	review.save()
		...
		"blocks": [
			{
				...
				"type": "paragraph",
				"data": {
					"text": "Bhasha allows you to embed videos in lessons using popular video hosting platforms."
				},
			},
			{
				"id": "1ooWPn5Zmq",
				"type": "paragraph",
				"data": {
					"text": "You don't need to upload videos directly into Bhasha - simply copy the video URL from your preferred provider and paste it into the Lesson Editor."
				},
			},
			{
				"id": "tCJD0yMAGd",
				"type": "paragraph",
				"data": {
					"text": "Bhasha automatically detects the video source and embeds it for learners."
				},
			},
