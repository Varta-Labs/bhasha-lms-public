...
class LMSCourse(Document):
	...
	def validate_video_link(self):
		...
		if "youtube.com/watch?v=" in self.video_link:
			self.video_link = self.video_link.split("watch?v=")[-1].split("&")[0]
		elif "youtu.be/" in self.video_link:
			self.video_link = self.video_link.rstrip("/").split("/")[-1].split("?")[0]
		elif "youtube.com/embed/" in self.video_link:
			self.video_link = self.video_link.rstrip("/").split("/")[-1].split("?")[0]
