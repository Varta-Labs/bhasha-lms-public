<template>
	<div>
		...
		<div v-if="createdCourses.data?.length" class="bhasha-course-grid-shell mt-10">
			<div class="flex items-center justify-between mb-3">
				...
				>
					<span class="bhasha-home-see-all flex items-center gap-x-1 text-xs">
						<span>
							{{ __('See all') }}
						</span>
