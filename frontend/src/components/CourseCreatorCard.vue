<template>
	<div v-if="instructors?.length" class="border border-purple-200/60 dark:border-purple-900/40 rounded-2xl p-6 bg-gradient-to-br from-white via-purple-50/15 to-white dark:from-[#16161e] dark:via-[#1a1824] dark:to-[#16161e] shadow-lg">
		<div
			class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-bhasha-purple/10 text-bhasha-purple dark:text-purple-300 uppercase text-xs font-bold tracking-wider mb-5"
		>
			<span>✨</span>
