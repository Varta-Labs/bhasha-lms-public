<template>
	<div class="bhasha-discussions-heading">
		<Button
			v-if="!singleThread && !readOnlyMode"
			class="bhasha-discussions-new float-end"
	...
	<div
		v-else
		class="bhasha-discussions-empty flex flex-col items-center justify-center border-2 border-dashed mt-5 py-8"
	>
...
<style scoped>
.bhasha-discussions-heading {
	min-height: 2.75rem;
}

.bhasha-discussions-new {
...
.bhasha-discussions-empty {
	border-color: rgba(108, 92, 231, 0.2);
	border-radius: 1rem;
	background: rgba(248, 246, 255, 0.62);
	color: #625d68;
}

.bhasha-discussions-empty svg {
	color: #6c5ce7;
}
</style>
