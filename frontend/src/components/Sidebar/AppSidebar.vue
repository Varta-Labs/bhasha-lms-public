<template>
	<div
		class="bhasha-app-sidebar flex h-full flex-col justify-between overflow-x-hidden transition-all duration-300 ease-in-out"
		:class="sidebarStore.isSidebarCollapsed ? 'w-14' : 'w-56'"
	>
		<div
			class="bhasha-sidebar-scroll flex flex-col overflow-y-auto"
		...
		>
			...
			<div class="flex flex-col" v-if="sidebarSettings.data">
				<div v-for="link in sidebarLinks" class="mx-2 mb-3">
					<div
						v-if="!link.hideLabel"
						class="bhasha-sidebar-section-label mb-1.5 mt-2 flex gap-1.5 px-2 transition-all duration-300 ease-in-out"
					>
			...
			>
				<div
					class="bhasha-sidebar-more-toggle flex cursor-pointer items-center justify-between pe-2"
		...
		<div class="m-2 flex flex-col gap-1">
			<div
				...
				class="bhasha-sidebar-notice z-10 m-1 px-3 py-2.5 text-xs leading-5"
			>
				{{
					__(
			...
			<div
				...
				"
				class="bhasha-sidebar-card bhasha-sidebar-profile-card flex flex-col gap-3 px-3 py-3 text-ink-gray-9"
			>
				<div class="flex flex-col text-p-sm gap-1">
					<div class="inline-flex items-center gap-2">
						<span class="bhasha-sidebar-profile-card__icon">
							<User class="h-4 shrink-0" />
						</span>
				...
				>
					<Button
						...
						class="bhasha-sidebar-profile-card__button w-full"
					>
						<template #prefix>
			...
			>
				...
				>
					<Tooltip v-if="readOnlyMode && sidebarStore.isSidebarCollapsed">
						<button type="button" class="bhasha-sidebar-icon-button">
					...
					<Tooltip
						...
						:text="__('Visit Bhasha support')"
					>
						<button
							type="button"
							class="bhasha-sidebar-icon-button"
					...
					<Tooltip v-if="showOnboarding" :text="__('Help')">
						<button
							...
							"
						>
							<CircleHelp class="size-4 stroke-1.5" />
						</button>
					</Tooltip>
				</div>
				<Tooltip
		...
		<HelpModal
			...
			:logo="LMSOnboardingLogo"
			:afterSkip="(step) => capture('onboarding_step_skipped_' + step)"
			:afterSkipAll="() => capture('onboarding_steps_skipped')"
			:afterReset="(step) => capture('onboarding_step_reset_' + step)"
			:afterResetAll="() => capture('onboarding_steps_reset')"
			docsLink="https://bhasha.io"
		/>
...
import LMSOnboardingLogo from '@/components/Icons/LMSOnboardingLogo.vue'
...
const redirectToWebsite = () => {
	window.open('https://bhasha.io', '_blank')
}
