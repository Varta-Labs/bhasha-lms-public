<template>
	<div class="course-outline-panel p-3 h-full">
		<div
		...
		<div
			v-else
			:class="{
				'border border-purple-200/50 dark:border-purple-900/30 rounded-2xl py-3 px-3 bg-white/80 dark:bg-ink-gray-8/40 shadow-sm space-y-2.5':
...
.course-outline-panel :deep(.chapter-item) {
	margin-bottom: 0.45rem;
}

.course-outline-panel :deep(.chapter-item > div > button) {
	border: 1px solid transparent;
	border-radius: 0.9rem;
}

.course-outline-panel :deep(.chapter-item > div > button:hover) {
	border-color: rgba(108, 92, 231, 0.14);
	background: rgba(108, 92, 231, 0.065) !important;
}

.course-outline-panel :deep(.outline-lesson) {
	border: 1px solid transparent;
	border-radius: 0.75rem;
}

.course-outline-panel :deep(.outline-lesson:hover) {
	border-color: rgba(108, 92, 231, 0.12);
	background: rgba(108, 92, 231, 0.055) !important;
}

.course-outline-panel :deep(.outline-lesson.bg-purple-50\/80) {
	border-color: rgba(108, 92, 231, 0.2);
	background: rgba(108, 92, 231, 0.1) !important;
	color: #4a38c2;
}

.course-outline-panel :deep(button) {
