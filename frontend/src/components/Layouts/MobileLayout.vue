	...
	<div class="relative flex h-screen flex-col">
		...
		<div class="relative z-20">
			...
			<div
				...
				class="standalone:pb-4 fixed bottom-0 start-0 z-10 flex w-full max-w-full items-center justify-around border-t border-[#e8e0f8] bg-surface-white"
			>
				<button
				...
				>
					<component
						...
						:class="[isActive(tab) ? 'text-bhasha-accent' : 'text-ink-gray-5']"
					/>
				</button>
